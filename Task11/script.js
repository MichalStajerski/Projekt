...
var objects = {
  ...
  moveDown: function () {
    ...
    objects.drawCircles()// after figuring out which circles not include into canvas proceed to drawing
  },
...
function CreateLayout (startButton, body) {
  ...
  let totalSeconds = 0
  var time = setInterval(setTime, 1000)// we refresh it every sedond because that is the minimum value by which timer is supposed to change
